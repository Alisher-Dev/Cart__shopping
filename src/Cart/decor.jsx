        ...
        <Box maxW='1300px' display='flex' flexDirection={{base:'column-reverse', lg:'unset'}} w='100%' p="5px 10px">
                <Box w={{base:'100%', lg:'70%'}} minH='80vh' boxShadow='0 0 15px rgba(172, 152, 253, 0.300)' borderRadius='10px' m='5px' p='20px'>
                    <Box display={{base:'block', md:'flex'}} justifyContent='space-between' w='100%' mb='40px'>
                        ...
                        <Input className='InputPlaceholder' border='none' boxShadow='0 0 15px rgba(172, 152, 253, 0.300)' w={{base:'100%', md:'48%'}} display='inline' variant='outline' color='black' placeholder='Ф.И.О' />
                    </Box>
                    <Box display='flex' justifyContent='space-between' flexDirection={{base:'column', md:'unset'}} w='100%' mb='40px'>
                        ...
                        <Input className='InputPlaceholder' border='none' boxShadow='0 0 15px rgba(172, 152, 253, 0.300)' w={{base:'100%', md:'48%'}} display='inline' variant='outline' color='black' placeholder='Город / Район' />
                    </Box>
                    <Input className='InputPlaceholder' border='none' boxShadow='0 0 15px rgba(172, 152, 253, 0.300)' w='100%' mb='40px' display='inline' variant='outline' color='black' placeholder='Улица / Дом' />

                    <Input className='InputPlaceholder' border='none' boxShadow='0 0 15px rgba(172, 152, 253, 0.300)' w='100%' mb='40px' display='inline' variant='outline' color='black' placeholder='Комментарий для курьера' />
