...
const StoreProvider = ({children}) => { 
    ...
    useEffect(() => {
        ...
        // }) 
        setData([
            { id:1, img:"https://mediapark.uz/_next/image?url=https%3A%2F%2Fcdn.newmediapark.uz%2Fimages%2F4f490498-d06f-45c9-b9f9-c9ce02b0a6a5_test.jpg&w=640&q=75", Like:false, name:"Iphone12", title:"Iphone12 4/128 color:blue size:6x7", price:"8 000 000" },
